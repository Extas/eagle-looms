...
pero desactivará la lupa y la capacidad de arrastrar y mover imágenes.`,
  ...
  eagleFolderPathTooltip: [
    'Use / to separate Eagle folders. Tokens: {site}, {date}, {gallery}, {chapter}, {copyright}, {character}, {author}. The default Site / Date preset uses source date when available, otherwise import date.',
    '用 / 分隔 Eagle 文件夹。支持变量：{site}、{date}、{gallery}、{chapter}、{copyright}、{character}、{author}。默认 Site / Date 预设优先使用来源日期，缺失时使用导入日期。',
    'Use / to separate Eagle folders. Tokens: {site}, {date}, {gallery}, {chapter}, {copyright}, {character}, {author}. The default Site / Date preset uses source date when available, otherwise import date.',
    'Use / para separar carpetas de Eagle. Variables: {site}, {date}, {gallery}, {chapter}, {copyright}, {character}, {author}. El preajuste Site / Date usa fecha de origen o fecha de importacion.',
  ],
  eagleImportLimit: [
    'Eagle Import Limit',
    'Eagle 导入上限',
